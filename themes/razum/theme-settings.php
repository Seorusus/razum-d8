 ...
 */
function razum_form_system_theme_settings_alter(&$form, \Drupal\Core\Form\FormStateInterface &$form_state, $form_id = NULL) {
  ...
  $form['razum_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('razum sample setting'),
  '#default_value' => theme_get_setting('razum_example'),
